...
def create_ik_results(origin_dir, save_path):
    ...
    :param save_path: Base path for the new format. Two files will be generated: <save_path>_smplx_vals.pkl and <save_path>_betas.pkl
    :return:
    """
    ...
    for s in ik_beta_results:
        ik_beta_results[s] = np.concatenate(ik_beta_results[s])[:, None]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', required=True,
                        help="Base path for the new format. Two files will be generated: <save_path>_smplx_vals.pkl and <save_path>_betas.pkl.")
