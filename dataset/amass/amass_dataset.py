...
from dataset.h36m.h36m_dataset import h36m_skeleton, Human36mDataset
...
class AMASSDataset(MocapDataset):
    ...
    def __init__(self, path, split, cameras, camera_type="h36m", downsample=1):
        """
        ...
        self._cameras = copy.deepcopy(cameras)
