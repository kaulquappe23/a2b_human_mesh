...
from dataset.h36m.keypoint_order import H36MOrderFull
    ...
    def __init__(self, path):
        ...
        for cameras in self._cameras.values():
            for i, cam in enumerate(cameras):
                ...
                cam['focal_length'] = cam['focal_length'] / cam['res_w'] * 2 # focal length matching image in (-1, 1) interval
                if 'translation' in cam:
                    cam['translation'] = cam['translation'] / 1000  # mm to meters

                # Add combined intrinsic parameters vector
                # 1+1+2+2+3+2 = 11 values
        ...
        for subject, actions in data.items():
            ...
            for action_name, positions in actions.items():
                ...
                positions = positions[:, H36MOrderFull.to_17p_order()].copy() # h3.6m has 32 keypoints, some are redundant
